	...
	<div class="header_bottom">
			...
			<a href="<%=basePath%>"><img src="images/logo.jpg" width="294" height="49" alt="" title="绿城之都-南宁"></a>
       		...
       		<ul>
                ...
                <li><a href="scenicController/scenicView.do">旅游</a></li>      
...
电话：${contact.tel }&nbsp;<br />
传真：${contact.fax }</p>
	<p><iframe src="<%=basePath %>/contactController/map.do" width="600" height="500" frameborder="0" scrolling="no"></iframe></p>
 </div>

	...
	<div class="header_bottom">
			...
			<a href="../index.html"><img src="../images/logo.jpg" width="294" height="49" alt="" title="绿城之都-南宁"></a>
       		...
       		<ul>
        	    ...
        	    <li><a href="http://localhost:8080/lvcity/index.jsp">网站首页</a></li>      
...
<div class="container"> 		
      ...
      <ul class="ul_left">
   	    <c:if test="${!empty scenictype }">
				<c:forEach items="${scenictype}" var="scen">
                      <li><h3><a target="fengjing" href="<%=basePath%>scenicController/search.do?stid=${scen.stid}&pageNow=1">${scen.st}</a></h3></li>
                 </c:forEach>
		</c:if>
      </ul>
	...
	<iframe id="fengjing" name="fengjing" src="<%=basePath%>scenicController/showList.do?stid=${1}&pageNow=1"  style="float:right;width:712px;height:665px;border:1px solid #cccccc;background-color:white;"></iframe>

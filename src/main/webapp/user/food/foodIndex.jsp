...
<div class="header"> 
	...
	<div class="w1000">
    	...
    	<p>你好，欢迎光临绿城之都南宁！</p>
        <a href="<%=basePath%>Admin/login.jsp">管理网站</a>
	...
	<div class="header_bottom">
			...
			<a href="index.html"><img src="images/logo.jpg" width="294" height="49" alt="" title="绿城之都-南宁"></a>
       		...
       		<ul>
                ...
                <li><a href="<%=basePath%>scenicController/scenicView.do">旅游</a></li>      

                <li><a href="<%=basePath%>foodController/foodView.do">美食</a></li>      

                <li><a href="<%=basePath%>noticeTypeController/noticeType.do">动态</a></li>      

                <li><a href="<%=basePath%>messageController/messageView.do">留言</a></li>   
				
				 <li><a href="<%=basePath%>teamController/teamView.do">团队介绍</a></li>      

                <li><a href="<%=basePath%>contactController/contactView.do">联系我们</a></li>
		...
		<div class="content clearfix">
			...
			<c:if test="${!empty foodtypelist }">
				<c:forEach items="${foodtypelist}" var="foodtype">
					<li><h3><a target="meishi" href="<%=basePath%>foodController/search.do?ftid=${foodtype.ftid}&pageNow=1">${foodtype.ft }</a></h3></li>
				</c:forEach>
			</c:if>
         			</ul>
			...
			<iframe id="meishi" name="meishi" src="<%=basePath%>foodController/showList.do?action=showList&ftid=${firstfoodtypeid}&pageNow=1"  style="float:right;width:712px;height:665px;border:1px solid #cccccc;background-color:white;"></iframe>
...
<p>Copyright &copy; 2015－2016 All Rights Reserved 版权所有 XXXXXXXXXXXXXXXXXX</p>
  <p>地址：XXXXXXXXXXXXXXXXXX  来源:<a href="http://www.mycodes.net/" target="_blank"></a> </p>
</div>

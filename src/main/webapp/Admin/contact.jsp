...
<body>
	...
	<table id="contact_dg" class="easyui-datagrid" style="height: 670px;"
		url="contactController/findAll.do" toolbar="#contact_toolbar" pagination="true"
	...
	<script type="text/javascript">
		...
		function editContact() {
			...
			if (row) {
				...
				url = 'contactController/add.do?contactid=' + row.contactid;
			}
		...
		function destroyContact() {
			...
			if (row) {
				$.messager.confirm('Confirm', '确定要删除吗?', function(r) {
					if (r) {
						$.post('contactController/delete.do', {

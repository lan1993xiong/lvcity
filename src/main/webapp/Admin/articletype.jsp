...
<body>
   <!-- 
	...
	<table id="articletype_dg" class="easyui-datagrid" style="height: 670px;"
		url="articletypeController/findAll.do" toolbar="#articletype_toolbar" pagination="true"
	...
	<script type="text/javascript">
		...
		function newarticletype() {
			...
			url = 'articletypeController/addArticletype.do';
		}
		function editarticletype() {
			...
			if (row) {
				...
				url = 'articletypeController/editArticletype.do?atid=' + row.atid;
			}
		}
		...
		function destroyarticletype() {
			...
			if (row) {
				$.messager.confirm('Confirm', '确定要删除吗?', function(r) {
					if (r) {
						$.post('articletypeController/delete.do?atid='+row.atid, {

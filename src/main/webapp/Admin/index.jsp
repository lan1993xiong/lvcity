		...
		<div data-options="region:'west',title:'菜单',split:true"
			...
			<div id="aa" class="easyui-accordion"
				...
				<div title="退出系统" data-options="iconCls:'icon-save'"
					style="overflow: auto; padding: 10px;">
					<a  href="http://localhost:8080/lvcity/index.jsp" class="easyui-linkbutton"
						data-options="plain:true" >退出系统</a><br/>
				</div>
		...
		<div  id="dataContent" data-options="region:'center',border:false,plain:true">
			<div id="tt" class="easyui-tabs" fit=true>
				<div title="首页" style="text-align: center; font-size: 24px;">
					...
					<a href="" target="new" style="color:blue;text-decoration:none;">点击进入前台页面</a>
				</div>
			</div>
		</div>
